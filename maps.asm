...
INCLUDE "data/maps/headers/FarawayFerryDock.asm"
INCLUDE "scripts/FarawayFerryDock.asm"
INCLUDE "data/maps/objects/FarawayFerryDock.asm"
FarawayFerryDock_Blocks: INCBIN "maps/FarawayFerryDock.blk"
